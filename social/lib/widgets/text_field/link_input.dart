            ...
            child: Row(
              children: [
                ...
                buildChooseButton(context,
                    ...
                    text: '小程序'.tr,
                    iconData: IconFont.buffChannelLink, onTap: () {
  ...
  Widget buildInput() {
    if (linkType == _LinkTypes.url)
      ...
      return WxProgramInput(
        wxProgramBean: _linkBean ?? WxProgramBean(''),
        clearCallback: clearCallback,
        onChanged: (bean) {
          widget?.onChanged?.call(bean);
        ...
        children: [
          Container(
            ...
            child: Row(
              children: [
                Icon(
                  iconData ?? IconFont.buffChannelLink2,
                  size: 16,
                  color: iconColor,
                ),
                sizeWidth4,
