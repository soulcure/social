        ...
        try {
          for (final element in registeredElements.value) {
            ...
            if (widget.scrollDirection == Axis.vertical) {
              ...
              ///点击红包或者跳转三方app后再返回后，reveal的值有可能不正常，导致消息公屏的滚动监听失效。
              ///从而导致一系列问题：消息公屏的底部未读数提示就没法消除，向上和向下加载方法也没法触发。
              if (!reveal?.isFinite ?? true) continue;
          ...
          debugPrint(
              "_schedulePositionNotificationUpdate exception ${e.toString()}");
        }
