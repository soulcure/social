...
class _ScrollablePositionedListState extends State<ScrollablePositionedList>
  ...
  void _jumpTo({@required int index, double alignment, double offset = 0}) {
  ...
  Future<void> _startScroll({
    ...
    final itemPosition = primary.itemPositionsNotifier.itemPositions.value
        .firstWhere((itemPosition) => itemPosition.index == index,
            orElse: () => null);
...
class _ListDisplayDetails {
  _ListDisplayDetails(this.key, {this.scrollController, this.offset = 0}) {
    if (scrollController == null) {
      scrollController = ScrollController(
          keepScrollOffset: false, initialScrollOffset: offset);
    }
  }
