...
class PolyStyles extends InheritedWidget {
  const PolyStyles({
    this.data,
    Widget child,
    Key key,
  ...
  @override
  bool updateShouldNotify(PolyStyles oldWidget) {
    return data != oldWidget.data;
  }

  static DefaultStyles getStyles(BuildContext context, bool nullOk) {
    final widget = context.dependOnInheritedWidgetOfExactType<PolyStyles>();
