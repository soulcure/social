...
import 'share_preference_session_windows.dart' if (dart.library.html) 'share_preference_session.dart';
...
class SessionSharePreference {
  ...
  void setValue(String valueType, String key, Object value) {
    SessionSharePreference.sessionManager.setValue(valueType, '$keyPrefix$key', value);
    if (value == null) {
      _allMap.remove(key);
    } else {
      _allMap[key] = value;
