class TranslationEn {
  static Map<String, String> get translationEn {
    return {
      ...
      "验证码已过期": "Verification time exceeded",
      ...
      "未注册的手机号验证后自动登录":
          "Unregistered cell phone numbers are automatically logged in after verification",
      ...
      "%s的手机号验证后自动登录": "Phone number of %s will auto-login after verfication",
      "未注册": "Unregistered",
      "30天内自动登录": "Automatic login within 30 days",
      "阅读并同意隐私政策、用户协议和服务器公约才能登录":
          "You have to agree to Privacy Policy, User Agreement and Community Rules to login",
      ...
      "服务器邀请码示例：SVgd7FZ3 或\nhttps://fanbook.mobi/SVgd7FZ3":
          "Invite code example: SVgd7FZ3 or https://fanbook.mobi/SVgd7FZ3",
