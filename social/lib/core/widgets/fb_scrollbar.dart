...
const double _kScrollbarMinLength = 36;
const double _kScrollbarMinOverscrollLength = 8;
...
// to the top.
const double _kScrollbarMainAxisMargin = 3;
const double _kScrollbarCrossAxisMargin = 3;
...
class FBScrollbar extends RawScrollbar {
...
class _FBScrollbarState extends RawScrollbarState<FBScrollbar> {
