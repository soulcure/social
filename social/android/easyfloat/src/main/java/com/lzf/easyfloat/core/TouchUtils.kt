...
internal class TouchUtils(val context: Context, val config: FloatConfig) {
    ...
    private fun initBoarderValue(view: View, params: LayoutParams) {
        ...
        Log.e("Q1","总宽度parentWidth::$parentWidth,,边缘::${config.rightBorder}，视图::${view.width}，最总:$rightBorder")
//        E/Q1: 总宽度parentWidth::1080,,边缘::9999，视图::540，最总:540
        // 出错
//        E/Q1: 总宽度parentWidth::948,,边缘::9999，视图::540，最总:408
