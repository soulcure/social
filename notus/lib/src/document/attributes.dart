...
class NotusAttribute<T> implements NotusAttributeBuilder<T> {
  static final Map<String, NotusAttributeBuilder> _registry = {
    ...
    //    修改，添加at channel
    NotusAttribute.at.key: NotusAttribute.at,
    NotusAttribute.channel.key: NotusAttribute.channel,
  };
  ...
  static const at = AtAttributeBuilder._();

  static const channel = ChannelAttributeBuilder._();
...
class AtAttributeBuilder extends NotusAttributeBuilder<String> {
  static const _kAt = 'at';
  const AtAttributeBuilder._() : super._(_kAt, NotusAttributeScope.inline);
...
class ChannelAttributeBuilder extends NotusAttributeBuilder<String> {
  static const _kChannel = 'channel';
  const ChannelAttributeBuilder._()
      : super._(_kChannel, NotusAttributeScope.inline);
