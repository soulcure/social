...
class MyCupertinoSwitch extends StatefulWidget {
  ...
  /// {@tempflutter.cupertino.MyCupertinoSwitch.dragStartBehavior}
...
class _MyCupertinoSwitchState extends State<MyCupertinoSwitch>
  ...
  @override
  void didUpdateWidget(MyCupertinoSwitch oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return Opacity(
      opacity: 1,
      child: _MyCupertinoSwitchRenderObjectWidget(
        value: widget.value,
...
class _MyCupertinoSwitchRenderObjectWidget extends LeafRenderObjectWidget {
  const _MyCupertinoSwitchRenderObjectWidget({
    Key? key,
    required this.value,
  ...
  final Color trackColor;
  final ValueChanged<bool> onChanged;
  final _MyCupertinoSwitchState state;
  final TextDirection textDirection;

  @override
  _RenderMyCupertinoSwitch createRenderObject(BuildContext context) {
    return _RenderMyCupertinoSwitch(
      value: value,
  ...
  void updateRenderObject(
      BuildContext context, _RenderMyCupertinoSwitch renderObject) {
    renderObject
      ..value = value
      ..activeColor = activeColor
      ..trackColor = trackColor
...
const double _kSwitchWidth = 59;
const double _kSwitchHeight = 39;
// Opacity of a disabled switch, as eye-balled from iOS Simulator on Mac.

const Duration _kReactionDuration = Duration(milliseconds: 300);
const Duration _kToggleDuration = Duration(milliseconds: 200);

class _RenderMyCupertinoSwitch extends RenderConstrainedBox {
  _RenderMyCupertinoSwitch({
    required bool value,
    required Color activeColor,
    required Color trackColor,
    ValueChanged<bool>? onChanged,
    required TextDirection textDirection,
    required _MyCupertinoSwitchState state,
  })  : _value = value,
  ...
  final _MyCupertinoSwitchState _state;
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final Rect thumbBounds = Rect.fromLTRB(
      thumbLeft + 3.px,
      thumbCenterY - CupertinoThumbPainter.radius + 3.px,
      thumbRight - 3.px,
      thumbCenterY + CupertinoThumbPainter.radius - 3.px,
    );

    _clipRRectLayer = context
