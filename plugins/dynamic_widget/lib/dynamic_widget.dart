...
class DynamicWidgetBuilder {
  ...
  static void addParser(WidgetParser parser) {
    print(
        "[Dynamic Widget] add custom widget parser, make sure you don't overwirte the widget type.");
    _parsers.add(parser);
  ...
  static Widget? buildFromMap(Map<String, dynamic>? map,
    ...
    print("[Dynamic Widget] Not support parser type: $widgetName");
    return null;
  }
  ...
  static Map<String, dynamic>? export(
    ...
    print(
        "[Dynamic Widget] Can't find WidgetParser for Type ${widget.runtimeType} to export.");
    return null;
  }
